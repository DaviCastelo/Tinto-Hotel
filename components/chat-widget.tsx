...
export function ChatWidget() {
  ...
  const generateGoogleMapsUrl = () => {
    const hotelAddress = "Av. Almirante Barroso, 727 - apto 101 - Praia de Iracema, Fortaleza - CE, 60060-440"
    const encodedAddress = encodeURIComponent(hotelAddress)
    return `https://www.google.com/maps/dir/?api=1&destination=${encodedAddress}`
  }

  const generateWhatsAppUrl = () => {
    const phoneNumber = "5585981493127"
                  ...
                  {quotationStep === 'initial' && (
                    <>
                      <p className="text-sm text-gray-800 mb-2">
                        Olá, bem vindo ao TINTTO Hotel! Sou uma assistente virtual e estou aqui 24h para te auxiliar no que for preciso 😊
                      </p>
                    ...
                    <>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 mb-4">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-sm text-gray-800 mb-2">TINTTO Hotel</h4>
                            <p className="text-sm text-gray-700 leading-relaxed">
                              Av. Almirante Barroso, 727 - apto 101 - Praia de Iracema<br />
